package com.studentapp.student_client_server;
...
public class ShowSingleRecordActivity extends AppCompatActivity {
    ...
    String HttpURL = "https://zpannualball.000webhostapp.com/Student/FilterStudentData.php";

    // Http URL for delete Already Open Student Record.

    String HttpUrlDeleteRecord = "https://zpannualball.000webhostapp.com/Student/DeleteStudent.php";
